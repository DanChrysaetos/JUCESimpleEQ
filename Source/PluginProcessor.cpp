...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    // Add low freq cut parameter float
    ...
    // Add high freq cut parameter float
    ...
    // Add peak quality range float
    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Quality", "Peak Quality", juce::NormalisableRange<float>(0.1f, 10.f, 0.05, 1.f), 1.f));
    
    // Create different slope for the low/high cut
    ...
    // Low cut slope parameter choice
    layout.add(std::make_unique<juce::AudioParameterChoice>("LowCut Slope", "LowCut Slope", stringArray, 0));
    
    // High cut slope parameter choice
